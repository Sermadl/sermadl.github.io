...
> 2025.03.14<br>찾았습니다! [요기](https://sermadl.github.io/posts/Aggregation/)로 오세욧<br>Federated 관련 설정을 아예 없애도 좋습니다 *^^* <br>(즉, init.sql 및 .env, .sh 파일이 없어도 되고, docker-compose.yml에서도 init.sql 관련 코드가 없어도 된다는 의미입니다 하하)
